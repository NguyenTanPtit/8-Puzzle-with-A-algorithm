...
public class BoardControl{
    ...
    public void setTimerSpeed(SPEED speed){
        switch (speed) {
            case SLOW -> this.timerSpeed = 700;
            case MEDIUM -> this.timerSpeed = 300;
            case FAST -> this.timerSpeed = 100;
        }
    }
    ...
    public boolean isSolved(){
        return Arrays.equals(this.current, GOAL);
    }
    ...
    public void solve(GUI gui, Solvers.SOLVE_METHOD method){
        ...
        Map<String, byte[]> parent;
        
        this.solving = true;
        
        long time = System.nanoTime();
        parent = switch (method) {
            case A_STAR -> Solvers.aStar(getCurrentBoard().clone());
        };
